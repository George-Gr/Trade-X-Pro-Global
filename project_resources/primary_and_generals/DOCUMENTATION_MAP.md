...
**First Day**:
3. ARCHITECTURE_DECISIONS.md - Why things work this way
4. STYLE_GUIDE.md - How to code

**First Week**:
5. DESIGN_SYSTEM.md - Design patterns
6. COMPONENT_API.md - Components
7. CONTRIBUTING_DESIGN_SYSTEM.md - How to contribute
