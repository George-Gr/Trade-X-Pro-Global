...
export const ASSET_CLASS_CONFIG: Record<string, {
  ...
  'EURUSD': { leverage: 500, maintenanceMarginRatio: 2, minQuantity: 0.01, maxQuantity: 1000 },
  'USDJPY': { leverage: 500, maintenanceMarginRatio: 2, minQuantity: 0.01, maxQuantity: 1000 },
  'GBPUSD': { leverage: 500, maintenanceMarginRatio: 2, minQuantity: 0.01, maxQuantity: 1000 },
  'USDCHF': { leverage: 500, maintenanceMarginRatio: 2, minQuantity: 0.01, maxQuantity: 1000 },

  // Forex Minors (less liquid)
  'NZDCAD': { leverage: 300, maintenanceMarginRatio: 5, minQuantity: 0.01, maxQuantity: 500 },
  'AUDCAD': { leverage: 300, maintenanceMarginRatio: 5, minQuantity: 0.01, maxQuantity: 500 },

  // Forex Exotics (high volatility, high risk)
  'USDTRY': { leverage: 100, maintenanceMarginRatio: 10, minQuantity: 0.01, maxQuantity: 100 },
  'USDRUB': { leverage: 100, maintenanceMarginRatio: 10, minQuantity: 0.01, maxQuantity: 100 },

  // Indices CFDs (moderate leverage)
  'US500': { leverage: 200, maintenanceMarginRatio: 5, minQuantity: 0.1, maxQuantity: 10000 },
  'US100': { leverage: 200, maintenanceMarginRatio: 5, minQuantity: 0.1, maxQuantity: 10000 },
  'UK100': { leverage: 200, maintenanceMarginRatio: 5, minQuantity: 0.1, maxQuantity: 10000 },
  'GER40': { leverage: 200, maintenanceMarginRatio: 5, minQuantity: 0.1, maxQuantity: 10000 },

  // Commodities (variable leverage)
  'XAUUSD': { leverage: 500, maintenanceMarginRatio: 5, minQuantity: 0.01, maxQuantity: 1000 }, // Gold
  'XAGUSD': { leverage: 500, maintenanceMarginRatio: 5, minQuantity: 1, maxQuantity: 10000 }, // Silver
  'WTIUSD': { leverage: 500, maintenanceMarginRatio: 5, minQuantity: 0.01, maxQuantity: 1000 }, // WTI Crude
  'BRENTUSD': { leverage: 500, maintenanceMarginRatio: 5, minQuantity: 0.01, maxQuantity: 1000 }, // Brent

  // Stocks (low leverage, high maintenance requirement)
  'AAPL': { leverage: 20, maintenanceMarginRatio: 25, minQuantity: 0.1, maxQuantity: 100000 },
  'TSLA': { leverage: 20, maintenanceMarginRatio: 25, minQuantity: 0.1, maxQuantity: 100000 },
  'MSFT': { leverage: 20, maintenanceMarginRatio: 25, minQuantity: 0.1, maxQuantity: 100000 },
  'GOOGL': { leverage: 20, maintenanceMarginRatio: 25, minQuantity: 0.1, maxQuantity: 100000 },

  // Cryptocurrencies (highly volatile, moderate leverage)
  'BTCUSD': { leverage: 5, maintenanceMarginRatio: 15, minQuantity: 0.001, maxQuantity: 100 },
  'ETHUSD': { leverage: 5, maintenanceMarginRatio: 15, minQuantity: 0.01, maxQuantity: 1000 },
  'XRPUSD': { leverage: 5, maintenanceMarginRatio: 15, minQuantity: 1, maxQuantity: 1000000 },

  // ETFs (similar to stocks)
  'SPY': { leverage: 20, maintenanceMarginRatio: 25, minQuantity: 0.1, maxQuantity: 100000 },
  'QQQ': { leverage: 20, maintenanceMarginRatio: 25, minQuantity: 0.1, maxQuantity: 100000 },

  // Bonds (low volatility, high leverage possible)
  'US10Y': { leverage: 50, maintenanceMarginRatio: 3, minQuantity: 0.01, maxQuantity: 10000 },
};
...
export const MarginCalculationSchema = z.object({
  ...
  leverage: z.number().positive('Leverage must be positive').max(500, 'Leverage exceeds maximum'),
...
export function calculateLiquidationPrice(
  ...
  const marginBuffer = entryPrice * leverage * (1 - maintenanceMarginRatio / 100);
...
export function calculateMarginSummary(
  ...
  if (totalMarginUsed > totalEquity) {
    ...
    marginLevel = totalMarginUsed > 0 ? (totalEquity / totalMarginUsed) * 100 : 0;
  } else {
    freeMargin = calculateFreeMargin(totalEquity, totalMarginUsed);
    marginLevel = totalMarginUsed > 0 
  ...
  let marginLevelStatus: 'safe' | 'warning' | 'critical' | 'liquidation' = 'safe';
  if (marginLevel < 50) {
 ...
 */
export function getAssetConfig(symbol: string): typeof ASSET_CLASS_CONFIG[keyof typeof ASSET_CLASS_CONFIG] {
  return (
