...
describe('MarginLevelCard', () => {
  describe('Loading State', () => {
    ...
    it('should not display specific content when loading (show skeletons instead)', () => {
      const { container } = render(<MarginLevelCard loading={true} marginLevel={50} trend={[]} />);
  ...
  describe('Value Clamping', () => {
    it('should clamp negative margin levels to 0', () => {
      const trend = [70, 72, 71, 73, 72, 75, 76];
      render(<MarginLevelCard loading={false} marginLevel={-10} trend={trend} />);
    ...
    it('should clamp margin levels > 100 to 100', () => {
      const trend = [70, 72, 71, 73, 72, 75, 76];
      render(<MarginLevelCard loading={false} marginLevel={150} trend={trend} />);
  ...
  describe('Sparkline Rendering', () => {
    ...
    it('should render single-value sparkline', () => {
      const trend = [75];
      render(<MarginLevelCard loading={false} marginLevel={75} trend={trend} />);
    ...
    it('should handle large trend values correctly', () => {
      ...
      render(<MarginLevelCard loading={false} marginLevel={2500} trend={trend} />);
  ...
  describe('Accessibility', () => {
    ...
    it('should have semantic card structure', () => {
      const trend = [70, 72, 71, 73, 72, 75, 76];
      const { container } = render(<MarginLevelCard loading={false} marginLevel={50} trend={trend} />);
