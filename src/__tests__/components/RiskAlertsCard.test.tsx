...
describe('RiskAlertsCard', () => {
  ...
  describe('Empty State', () => {
    ...
    it('should show descriptive message when no alerts', () => {
      ...
      const description = screen.getByText(
        /When your account approaches critical thresholds/i
      );
  ...
  describe('Populated State', () => {
    ...
    it('should display all alerts', () => {
      ...
      expect(
        screen.getByText(/Position Concentration Risk/)
      ).toBeInTheDocument();
    ...
    it('should display alert details when provided', () => {
      ...
      expect(
        screen.getByText(/Your margin level is below 30%/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/One position represents 45% of portfolio/)
      ).toBeInTheDocument();
    });
  ...
  describe('Severity Levels and Badges', () => {
    it('should render critical severity badge', () => {
      ...
      const { container } = render(
        <RiskAlertsCard loading={false} alerts={alerts} />
      );
  ...
  describe('Multiple Alerts', () => {
    it('should display multiple alerts in correct order', () => {
      ...
      const titleElems = Array.from(
        container.querySelectorAll('[class*="font-medium"]')
      );
    ...
    it('should render alerts as list items', () => {
      ...
      const alertRows = container.querySelectorAll(
  ...
  describe('Card Structure', () => {
    ...
    it('should have descriptive subtitle', () => {
      ...
      expect(
        screen.getByText(/Critical account notifications/i)
      ).toBeInTheDocument();
    });
    ...
    it('should have card footer with alert history text', () => {
      ...
      expect(
        screen.getByText(/View history for past alerts/i)
      ).toBeInTheDocument();
    });
  });
