...
describe("Sidebar Navigation Focus Ring Enhancement Tests", () => {
  it("should have 3px focus rings for sidebar menu buttons", () => {
    ...
    button.style.boxShadow =
      "0 0 0 4px hsl(var(--focus-ring-color) / 0.2), 0 4px 8px hsl(var(--focus-ring-color) / 0.1)";
    ...
    expect(button.style.backgroundColor).toContain(
      "hsl(var(--sidebar-accent) / 0.25)",
    );
    expect(button.style.boxShadow).toContain(
      "4px hsl(var(--focus-ring-color) / 0.2)",
    );
  ...
  it("should have enhanced focus rings for active sidebar items", () => {
    ...
    button.style.outlineOffset = "2px";
    button.style.boxShadow =
      "inset 4px 0 0 0 hsl(var(--focus-color)), 0 4px 12px hsl(var(--focus-ring-color) / 0.15), 0 0 0 6px hsl(var(--focus-ring-color) / 0.2)";
  ...
  it("should have high contrast focus rings for sidebar in high contrast mode", () => {
    ...
    expect(button.style.outlineOffset).toBe("2px");
    expect(button.style.backgroundColor).toContain(
      "hsl(var(--primary-contrast-light) / 0.8)",
    );
  ...
  it("should have dark mode focus rings for sidebar navigation", () => {
    ...
    button.style.boxShadow =
      "0 0 0 4px hsl(var(--focus-ring-color) / 0.3), 0 4px 8px hsl(var(--focus-ring-color) / 0.15)";
    ...
    expect(button.style.boxShadow).toContain(
      "4px hsl(var(--focus-ring-color) / 0.3)",
    );
  ...
  it('should have role="menuitem" focus styles for keyboard navigation', () => {
    ...
    button.style.boxShadow =
      "0 0 0 4px hsl(var(--focus-ring-color) / 0.25), 0 2px 4px hsl(var(--focus-ring-color) / 0.1)";
    ...
    expect(button.style.boxShadow).toContain(
      "4px hsl(var(--focus-ring-color) / 0.25)",
    );
...
describe("Sidebar Navigation Focus Ring Enhancement Tests", () => {
  ...
  it("should handle Home and End key navigation", async () => {
    ...
    const dashboardButton = screen.getByLabelText(/Dashboard/i) as HTMLElement;
    const settingsButtons = screen.getAllByLabelText(
      /Settings/i,
    ) as HTMLElement[];
