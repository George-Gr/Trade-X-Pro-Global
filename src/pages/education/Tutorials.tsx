          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Access comprehensive guides, video tutorials, and downloadable
                e-books
              </p>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      <span className="text-primary font-semibold text-sm hover:text-primary/80 transition-colors duration-150 cursor-pointer">
                        {item.count}
                      </span>
                    </div>
                  ))}
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      <span className="text-xs text-primary hover:text-primary/80 transition-colors duration-150 cursor-pointer">
                        Download
                      </span>
                    </div>
                  ))}
            ...
            <CardContent>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <Card
                    key={i}
                    className="border-border hover:shadow-lg transition-all duration-150"
                  >
                    <CardContent className="p-6">
