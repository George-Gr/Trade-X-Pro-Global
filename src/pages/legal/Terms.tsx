            ...
            <CardContent className=" space-y-6 prose prose-invert">
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  By accessing and using TradeX Pro's website and services, you
                  agree to be bound by these Terms and Conditions, all
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  We provide a platform for trading Contracts for Difference
                  (CFDs) on various financial instruments. CFDs are complex
                  leveraged instruments that carry a high level of risk and may
                ...
                <p className="text-muted-foreground mb-4">
                  We will use reasonable efforts to execute your orders
                  promptly, but we do not guarantee execution at your requested
                  price due to market conditions, slippage, and other factors
                  beyond our control.
                </p>
                ...
                <p className="text-muted-foreground">
                  You must maintain sufficient margin in your account. We
                  reserve the right to close out your positions if margin levels
                  fall below required thresholds. You are responsible for
                  monitoring your margin levels at all times.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  All deposits and withdrawals must comply with our Anti-Money
                  Laundering (AML) and Know Your Customer (KYC) policies. We
                  reserve the right to reject or delay transactions that do not
                  meet our compliance requirements. Withdrawals are processed to
                  the same payment method used for deposits where possible.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  <li>
                    Engage in market manipulation, scalping, or abusive trading
                    practices
                  </li>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  To the maximum extent permitted by law, TradeX Pro shall not
                  be liable for any indirect, incidental, special,
                  consequential, or punitive damages, including loss of profits,
                  data, or other intangible losses resulting from your use of
                  our services.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  obligations where such failure is a result of circumstances
                  beyond our reasonable control, including acts of God, war,
                  civil unrest, terrorism, market disruptions, or technical
                  failures.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  any time if you violate these terms, engage in prohibited
                  activities, or for any other reason at our sole discretion.
                  Upon termination, you must close all open positions and
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  with the laws of Seychelles. Any disputes arising from these
                  terms shall be subject to the exclusive jurisdiction of the
                  courts of Seychelles.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  will notify you of material changes by email or prominent
                  notice on our platform. Your continued use of our services
