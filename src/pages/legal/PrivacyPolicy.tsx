            ...
            <CardContent className=" space-y-6 prose prose-invert">
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  TradeX Pro ("we," "our," or "us") is committed to protecting
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed mb-4">
                  ...
                  when registering for an account, including:
                </p>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  <li>
                    Account creation and verification (KYC/AML compliance)
                  </li>
                  <li>
                    Processing transactions and managing your trading account
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  servers, and access controls. Your data is stored on secure
                  servers and is accessible only to authorized personnel who
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  ...
                  <li>
                    Professional advisors (lawyers, auditors) bound by
                    confidentiality
                  </li>
                </ul>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  agreements. Account information is typically retained for 7
                  years after account closure as required by financial
                  regulations.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  updated version will be indicated by an "Last Updated" date.
                  We will notify you of material changes by email or prominent
