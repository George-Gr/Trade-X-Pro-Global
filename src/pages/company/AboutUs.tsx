          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Empowering traders worldwide with professional tools, education,
                and support
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card>
              <CardContent>
                ...
                <p className="text-muted-foreground mb-6">
                  To democratize financial trading by providing accessible,
                  educational, and risk-free platform for traders of all levels
                  to learn, practice, and master CFD trading without financial
                  risk.
                </p>
                <p className="text-muted-foreground">
                  We believe trading should be learned in a safe environment
            ...
            <Card>
              <CardContent>
                ...
                <p className="text-muted-foreground mb-6">
                  To become the world's leading trading education and simulation
                  platform, recognized for excellence in trader development and
                  market expertise.
                </p>
                <p className="text-muted-foreground">
                  Building a community of informed, disciplined traders who
            ...
            <CardContent>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-4 p-6 bg-muted/50 rounded-lg"
                  >
