          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Get access to institutional-grade trading conditions with tight
                spreads, flexible leverage, and transparent pricing
              </p>
            </div>
          </div>
        </section>
            ...
            <Card>
              <CardContent>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Among the tightest in the industry
                    </p>
                  </div>
                </div>
                    ...
                    <tbody>
                      {[
                        ...
                        >
                          ...
                          <td className="p-4 text-center text-primary font-semibold hover:text-primary/80 transition-colors duration-150 cursor-pointer">
                            {row.ecn}
                          </td>
                        </tr>
                      ))}
                ...
                <p className="text-sm text-muted-foreground">
                  * Spreads shown are typical and may vary based on market
                  conditions. Forex spreads are floating and may widen during
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        >
                          <span className="font-medium hover:text-foreground transition-colors duration-150 cursor-pointer">
                            {item.asset}
                          </span>
                          <span className="text-primary font-semibold hover:text-primary/80 transition-colors duration-150 cursor-pointer">
                            {item.leverage}
                          </span>
                        </div>
                      ))}
                  ...
                  <div className="bg-warning/10 border border-warning/20 rounded-lg p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Leverage can amplify both gains and losses. A 10% market
                      move with 1:10 leverage results in a 100% account change.
                      Trade responsibly and always use stop-loss orders.
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Our platform includes automatic margin call alerts and
                      forced liquidation at 50% equity to protect your account.
                    </p>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div>
                    ...
                    <ul className="space-y-4">
                      {[
                        ...
                        <li
                          key={i}
                          className="flex items-start gap-4 p-4 bg-accent/10 rounded-lg"
                        >
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-primary-glow/5 border-primary/20">
              <CardContent className="p-8">
                <h2 className="text-3xl font-bold mb-4">
                  Start Trading with Professional Conditions
                </h2>
                <p className="text-xl text-muted-foreground mb-8">
                  Access competitive spreads, flexible leverage, and transparent
                  pricing
                </p>
