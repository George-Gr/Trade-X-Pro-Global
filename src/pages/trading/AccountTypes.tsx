          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Select from our diverse range of account types, each tailored to
                meet different trading needs and styles
              </p>
            </div>
          </div>
        </section>
            ...
            {[
              ...
              <Card
                ...
                className={`hover:shadow-lg transition-all duration-150 hover:-translate-y-1 ${
                  account.highlighted
                    ? "ring-2 ring-primary md:col-span-2 lg:col-span-1"
                    : ""
                }`}
              >
          ...
          <div className="text-center">
            <Card className="bg-gradient-to-br from-primary/10 to-primary-glow/5 border-primary/20">
              <CardContent className="p-8">
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Choose your preferred account type and start trading with
                  TradeX Pro
                </p>
