...
import { TrendingUp, BarChart3, AlertCircle, Calculator, Bell, Zap, CheckCircle2 } from "lucide-react";
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Powerful analysis, signals, and calculators to enhance your trading strategy
              </p>
            </div>
          </div>
        </section>
                  ...
                  {[
                    {
                      level: "Strong Buy",
                      strength: "90-100",
                      description: "Highly confident buy signal from multiple indicators"
                    },
                    {
                      level: "Buy",
                      strength: "70-89",
                    ...
                    },
                    {
                      level: "Strong Sell",
                      strength: "0-10",
                      description: "Highly confident sell signal from multiple indicators"
                    }
                  ].map((signal, i) => (
