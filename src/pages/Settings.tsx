...
import { CheckCircle2, Clock, XCircle, Loader2, Bell, Eye, Monitor, Palette, Volume2, Keyboard } from "lucide-react";
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => visualPreferences.updatePreference('highContrast', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => visualPreferences.updatePreference('reduceMotion', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => visualPreferences.updatePreference('largerText', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => visualPreferences.updatePreference('focusIndicator', checked)}
                    />
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-blue-600">
                      {Math.round(visualPreferences.preferences.highContrast ? 95 : 85)}%
                    </div>
                    <p className="text-sm text-muted-foreground mt-2">
                      {visualPreferences.preferences.highContrast ? 'Excellent' : 'Good'} compliance
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      visualPreferences.updatePreference('focusIndicator', false);
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded">
                    <p className="text-sm text-blue-800 font-medium">Keyboard Navigation</p>
                    <p className="text-xs text-blue-700 mt-1">
                      Use Tab to navigate, Enter to activate, and Esc to close modals
                    </p>
                  </div>
                  
                  <div className="p-3 bg-green-50 border border-green-200 rounded">
                    <p className="text-sm text-green-800 font-medium">Screen Reader</p>
                  ...
                  <div className="p-3 bg-purple-50 border border-purple-200 rounded">
                    <p className="text-sm text-purple-800 font-medium">Color Contrast</p>
