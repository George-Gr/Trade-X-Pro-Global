...
describe('PnL Calculations', () => {
  describe('calculateUnrealizedPnL', () => {
    it('calculates profit for long position when price increases', () => {
      const result = calculateUnrealizedPnL(1.1000, 1.1050, 1, 'long');
    ...
    it('calculates loss for long position when price decreases', () => {
      const result = calculateUnrealizedPnL(1.1000, 1.0950, 1, 'long');
    ...
    it('calculates profit for short position when price decreases', () => {
      const result = calculateUnrealizedPnL(1.1000, 1.0950, 1, 'short');
    ...
    it('calculates loss for short position when price increases', () => {
      const result = calculateUnrealizedPnL(1.1000, 1.1050, 1, 'short');
    ...
    it('returns breakeven when prices are equal', () => {
      const result = calculateUnrealizedPnL(1.1000, 1.1000, 1, 'long');
    ...
    it('scales with quantity', () => {
      const result1 = calculateUnrealizedPnL(1.1000, 1.1050, 1, 'long');
      const result2 = calculateUnrealizedPnL(1.1000, 1.1050, 2, 'long');
...
describe('Input Validation', () => {
  ...
  it('validates correct input', () => {
    const result = validateOrderInput({ symbol: 'EURUSD', quantity: 1, price: 1.1000 });
  ...
  it('rejects zero price', () => {
    const result = validateOrderInput({ symbol: 'EURUSD', quantity: 1, price: 0 });
    expect(result.valid).toBe(false);
