...
const SUPABASE_URL = ((import.meta as unknown as Record<string, unknown>).env as Record<string, unknown>)?.VITE_SUPABASE_URL as string || FALLBACK_URL;
const SUPABASE_PUBLISHABLE_KEY = ((import.meta as unknown as Record<string, unknown>).env as Record<string, unknown>)?.VITE_SUPABASE_PUBLISHABLE_KEY as string || FALLBACK_PUBLISHABLE_KEY;
