...
describe('marginCalculations', () => {
  describe('calculateMarginRequired', () => {
    ...
    it('returns 4-decimal precision', () => {
      ...
      expect(margin.toString().split('.')[1]?.length || 0).toBeLessThanOrEqual(4);
    });
  });
  ...
  describe('calculateFreeMargin', () => {
    ...
    it('throws error when margin exceeds equity', () => {
      expect(() => calculateFreeMargin(50000, 100000)).toThrow(MarginCalculationError);
    });
  ...
  describe('calculateMarginLevel', () => {
    ...
    it('throws error when margin used is zero', () => {
      expect(() => calculateMarginLevel(100000, 0)).toThrow(MarginCalculationError);
    });

    it('throws error when margin used is negative', () => {
      expect(() => calculateMarginLevel(100000, -1000)).toThrow(MarginCalculationError);
    });
  });
  ...
  describe('calculateMaxPositionSize', () => {
    ...
    it('throws error for negative equity', () => {
      expect(() => calculateMaxPositionSize(-1000, 5, 50000)).toThrow(MarginCalculationError);
    });

    it('throws error for zero/negative price', () => {
      expect(() => calculateMaxPositionSize(10000, 5, 0)).toThrow(MarginCalculationError);
      expect(() => calculateMaxPositionSize(10000, 5, -100)).toThrow(MarginCalculationError);
    });
  });
