...
export const spacingUtils = {
  ...
  margin: {
    ...
    mt: (size: keyof typeof SPACING_SCALE) =>
      `margin-top: var(--margin-${size});`,
    mb: (size: keyof typeof SPACING_SCALE) =>
      `margin-bottom: var(--margin-${size});`,
    ml: (size: keyof typeof SPACING_SCALE) =>
      `margin-left: var(--margin-${size});`,
    mr: (size: keyof typeof SPACING_SCALE) =>
      `margin-right: var(--margin-${size});`,
    mx: (size: keyof typeof SPACING_SCALE) =>
      `margin-left: var(--margin-${size}); margin-right: var(--margin-${size});`,
    my: (size: keyof typeof SPACING_SCALE) =>
      `margin-top: var(--margin-${size}); margin-bottom: var(--margin-${size});`,
  },
  ...
  padding: {
    ...
    pt: (size: keyof typeof SPACING_SCALE) =>
      `padding-top: var(--padding-${size});`,
    pb: (size: keyof typeof SPACING_SCALE) =>
      `padding-bottom: var(--padding-${size});`,
    pl: (size: keyof typeof SPACING_SCALE) =>
      `padding-left: var(--padding-${size});`,
    pr: (size: keyof typeof SPACING_SCALE) =>
      `padding-right: var(--padding-${size});`,
    px: (size: keyof typeof SPACING_SCALE) =>
      `padding-left: var(--padding-${size}); padding-right: var(--padding-${size});`,
    py: (size: keyof typeof SPACING_SCALE) =>
      `padding-top: var(--padding-${size}); padding-bottom: var(--padding-${size});`,
  },
