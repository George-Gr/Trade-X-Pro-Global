...
import { Loader2, TrendingUp, TrendingDown, Signal, Bookmark } from "lucide-react";
        ...
        {isMonitoring && pricesConnected && (
          <div className="bg-status-info/10 border-b border-status-info-border px-3 py-1.5 flex items-center gap-2">
            ...
            <p className="text-xs text-status-info-foreground">
              Monitoring {monitoredCount} position{monitoredCount !== 1 ? 's' : ''}
            </p>
          </div>
        )}
        ...
        <div className="border-b border-border px-4 py-3 bg-card">
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <div className={cn(
                  ...
                  isPositiveChange ? "bg-profit/10 text-profit" : "bg-loss/10 text-loss"
                )}>
            ...
            <div className="flex items-center gap-1.5 text-xs">
              ...
              <span className={isConnected ? "text-profit" : "text-muted-foreground"}>
