    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Real-time monitoring and optimization insights</p>
        </div>
        ...
        <div className="md:col-span-2 bg-card rounded-lg p-6 border">
          <div className="flex justify-between items-center">
            ...
            <div className={`p-3 rounded-full ${
              performanceScore.avg >= 90 ? 'bg-green-100' :
              performanceScore.avg >= 75 ? 'bg-yellow-100' : 'bg-red-100'
            }`}>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-muted rounded">
                  ...
                  <p className="text-2xl font-bold">{(memory.usedJSHeapSize / 1024 / 1024).toFixed(2)} MB</p>
                </div>
                <div className="p-4 bg-muted rounded">
                  <p className="text-sm text-muted-foreground">Total Heap</p>
                  <p className="text-2xl font-bold">{(memory.totalJSHeapSize / 1024 / 1024).toFixed(2)} MB</p>
                </div>
              </div>
        ...
        <div className="md:col-span-2 bg-card rounded-lg p-6 border">
          ...
          <div className="space-y-4">
            <div className={`flex items-center gap-3 p-3 rounded ${
              network.isOnline ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'
            }`}>
            ...
            {network.connection && (
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-muted rounded">
                  ...
                  <p className="font-semibold">{network.connection.effectiveType}</p>
                </div>
                <div className="p-3 bg-muted rounded">
                  <p className="text-sm text-muted-foreground">Downlink</p>
                  <p className="font-semibold">{network.connection.downlink} Mbps</p>
                </div>
              </div>
            )}
          </div>
