...
export const FeatureCard = ({
  ...
  return (
    <Card className={`border-border hover:shadow-lg transition-all hover:-translate-y-1 bg-card backdrop-blur-sm focus-within:ring-2 focus-within:ring-primary ${className}`}>
