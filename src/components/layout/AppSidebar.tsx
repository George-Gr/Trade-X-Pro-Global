                    ...
                    return (
                      <SidebarMenuItem key={item.id}>
                        <SidebarMenuButton
                          ...
                          className={cn(
                            "gap-3 px-4 py-2 transition-all duration-200",
                            !item.disabled && "hover-lift hover:bg-sidebar-accent/50",
                            isActive(item.path) && "bg-sidebar-accent text-sidebar-accent-foreground font-semibold shadow-sm",
                            collapsed && "justify-center px-2",
                        ...
                        >
                          <Icon className={cn(
                            ...
                            isActive(item.path) ? "text-primary icon-glow" : "text-muted-foreground group-hover:text-foreground"
                          )} />
                          <span className={cn(
