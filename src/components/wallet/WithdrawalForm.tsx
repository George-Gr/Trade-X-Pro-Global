    ...
    <div className="space-y-6">
        ...
        <Card className="glass-card">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Daily limit: ${WITHDRAWAL_LIMITS.daily}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      {!isKYCVerified && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            KYC verification required to withdraw. Please complete verification
            first.
          </AlertDescription>
        </Alert>
      )}
        ...
        <div className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormMessage />
                    <p className="text-xs text-muted-foreground">
                      Enter a valid {watchedCurrency} address. This cannot be
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="border-t pt-4 flex justify-between">
                  ...
                  <span className="font-bold text-primary">
                    {(parseFloat(amount) - networkFee).toFixed(8)} {currency}
                  </span>
                </div>
              </CardContent>
            </Card>
          ...
          <Alert>
            ...
            <AlertDescription className="text-xs">
              <strong>Important:</strong> Double-check the address. Funds sent
              to an incorrect address cannot be recovered.
            </AlertDescription>
          </Alert>
        </div>
      )}
