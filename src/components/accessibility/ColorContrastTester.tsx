import React, { useState, useRef } from 'react';import { useColorContrastVerification, useColorBlindMode, useVisualAccessibilityPreferences } from '@/lib/colorContrastVerification';
...
export const ColorContrastTester: React.FC<ColorContrastTesterProps> = () => {
  ...
  const testColorCombination = () => {
    const ratio = calculateContrast(selectedColors.foreground, selectedColors.background);
  ...
  const sampleColorCombinations = [
    { name: 'Dark Text on Light Background', fg: '#000000', bg: '#ffffff', expected: 'AAA' },
    { name: 'Light Text on Dark Background', fg: '#ffffff', bg: '#000000', expected: 'AAA' },
    { name: 'Gray Text on White', fg: '#666666', bg: '#ffffff', expected: 'AA' },
    { name: 'Blue Link on White', fg: '#1976d2', bg: '#ffffff', expected: 'AA' },
    { name: 'Red Error Text', fg: '#d32f2f', bg: '#ffffff', expected: 'AA' },
    { name: 'Green Success Text', fg: '#2e7d32', bg: '#ffffff', expected: 'AA' },
    { name: 'Orange Warning Text', fg: '#ef6c00', bg: '#ffffff', expected: 'AA' },
    { name: 'Purple Accent Text', fg: '#7b1fa2', bg: '#ffffff', expected: 'AA' },
      ...
      <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <input
                        ...
                        onChange={(e) => setSelectedColors(prev => ({ ...prev, foreground: e.target.value }))}
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <input
                        ...
                        onChange={(e) => setSelectedColors(prev => ({ ...prev, background: e.target.value }))}
                        className="w-12 h-12 border rounded cursor-pointer"
                      />
                      <input
                        type="text"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      ...
                      onChange={(e) => setCustomElement(prev => ({ ...prev, fontSize: parseInt(e.target.value) }))}
                      className="w-full"
                    />
                    <select
                      value={customElement.fontWeight}
                      onChange={(e) => setCustomElement(prev => ({ ...prev, fontWeight: e.target.value }))}
                  ...
                  <input
                    ...
                    onChange={(e) => setCustomElement(prev => ({ ...prev, text: e.target.value }))}
                ...
                {sampleColorCombinations.map((combo, index) => {
                  ...
                  return (
                    <div key={index} className="p-4 border rounded">
                      ...
                      <button
                        onClick={() => {
                          setSelectedColors({ foreground: combo.fg, background: combo.bg });
        ...
        {activeTest === 'simulation' && (
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border">
              <h3 className="font-semibold mb-4">Color Blind Mode Simulation</h3>
              <p className="text-sm text-muted-foreground mb-4">
                Test how your color choices appear to users with different types of color vision deficiency
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  {colorBlindMode.availableModes.map((mode) => (
                    <label key={mode.type} className="flex items-center space-x-3 cursor-pointer">
                      <input
                        type="radio"
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{mode.name}</p>
                      </div>
                    </label>
                  ))}
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <button
                    onClick={() => colorBlindMode.applyColorBlindSimulation({ type: 'none', intensity: 0 })}
                    className="px-4 py-2 bg-gray-500 text-white rounded-lg font-medium"
                  >
                    Reset Simulation
                  </button>
            ...
            <div className="bg-card rounded-lg p-6 border">
              <h3 className="font-semibold mb-4">Test Colors with Simulation</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">Foreground Color</label>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <p>This text shows how your colors appear with the current color blind simulation applied.</p>
                  </div>
        ...
        {activeTest === 'preferences' && (
          <div className="space-y-6">
            {/* Visual Preferences */}
            <div className="bg-card rounded-lg p-6 border">
              <h3 className="font-semibold mb-4">Visual Accessibility Preferences</h3>
              ...
              <div className="space-y-6">
                ...
                <label className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) => visualPreferences.updatePreference('focusIndicator', e.target.checked)}
                    className="text-blue-600"
                  />
                </label>
                ...
                <label className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) => visualPreferences.updatePreference('readingGuide', e.target.checked)}
                    className="text-blue-600"
                  />
                </label>
              </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-4 border rounded">
                      ...
                      <div className="flex space-x-4 mt-2">
                        <span className="px-3 py-2 bg-gray-200 text-gray-800 rounded">Gray Button</span>
                        <span className="px-3 py-2 bg-blue-200 text-blue-800 rounded">Blue Button</span>
                        <span className="px-3 py-2 bg-green-200 text-green-800 rounded">Green Button</span>
                      </div>
                    </div>
                    ...
                    <div className="p-4 border rounded bg-black text-white">
                      ...
                      <div className="flex space-x-4 mt-2">
                        <span className="px-3 py-2 bg-white text-black rounded">Gray Button</span>
                        <span className="px-3 py-2 bg-blue-600 text-white rounded">Blue Button</span>
                        <span className="px-3 py-2 bg-green-600 text-white rounded">Green Button</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="p-4 border rounded">
                      ...
                      <p className="text-sm mt-2">This is sample text at normal size.</p>
                    </div>
                    
                    <div className="p-4 border rounded text-lg">
                      <p className="font-medium">Large Text Size</p>
                      <p className="mt-2">This is sample text at larger size.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    {result.type === 'color_contrast' ? (
                      <div className="text-sm text-muted-foreground mt-1">
                        <p>Foreground: {result.foreground} | Background: {result.background}</p>
                        <p>Ratio: {result.ratio}:1 | Level: {result.level}</p>
                        <p>{result.passed ? '✓ PASSED' : '✗ FAILED'} WCAG compliance</p>
                      </div>
                    ) : (
