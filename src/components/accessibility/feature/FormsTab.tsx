      ...
      <div className="bg-card rounded-lg p-6 border">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            {(() => {
              ...
              return (
                <input
                  ...
                  type="text"
                  {...rest}
                  ref={(el) => { ref(el); if (inputRefs?.current) inputRefs.current.username = el; }}
            ...
            <div id="username-help" className="text-sm text-muted-foreground mt-1">
            ...
            {(() => {
              ...
              return (
                <input
                  ...
                  type="email"
                  {...rest}
                  ref={(el) => { ref(el); if (inputRefs?.current) inputRefs.current.email = el; }}
          ...
          <div>
            ...
            {(() => {
              ...
              return (
                <input
                  ...
                  type="password"
                  {...rest}
                  ref={(el) => { ref(el); if (inputRefs?.current) inputRefs.current.password = el; }}
            ...
            <div id="password-help" className="text-sm text-muted-foreground mt-1">
          ...
          <div>
            ...
            {(() => {
              ...
              return (
                <input
                  ...
                  type="password"
                  {...rest}
                  ref={(el) => { ref(el); if (inputRefs?.current) inputRefs.current.confirmPassword = el; }}
            ...
            <div id="confirm-help" className="text-sm text-muted-foreground mt-1">
          ...
          <div>
            ...
            {(() => {
              ...
              return (
                <select
                  id="country"
                  {...rest}
                  ref={(el) => { ref(el); if (inputRefs?.current) inputRefs.current.country = el; }}
            ...
            <div id="country-help" className="text-sm text-muted-foreground mt-1">
            ...
            {(() => {
              ...
              return (
                <textarea
                  id="bio"
                  {...rest}
                  ref={(el) => { ref(el); if (inputRefs?.current) inputRefs.current.bio = el; }}
              ...
              {(() => {
                ...
                return (
                  <input
                    type="checkbox"
                    {...rest}
                    ref={(el) => { ref(el); if (inputRefs?.current) (inputRefs.current as any).terms = el; }}
              ...
              {(() => {
                ...
                return (
                  <input
                    type="checkbox"
                    {...rest}
                    ref={(el) => { ref(el); if (inputRefs?.current) (inputRefs.current as any).newsletter = el; }}
      ...
      <div className="bg-card rounded-lg p-6 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 border border-blue-200 rounded">
            ...
            <p className="text-2xl font-bold text-blue-900">{formAccessibility.formFields.length}</p>
          </div>
