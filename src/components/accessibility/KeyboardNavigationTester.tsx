      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Interactive testing environment for keyboard shortcuts and
            navigation
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Global keyboard shortcuts (Ctrl+B, Ctrl+S, etc.) are available
                when this page has focus. Click the buttons below to simulate
                trades or use the global shortcuts.
              </p>
        ...
        {activeTest === "focus" && (
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div
                ref={containerRef}
                className="space-y-4 p-4 border-2 border-dashed rounded"
              >
                <input
                  ref={inputRef}
                  type="text"
      ...
      <div className="bg-card rounded-lg p-6 border">
        ...
        <div className="space-y-3">
          {testResults.length === 0 ? (
            <p className="text-muted-foreground">
              No test results yet. Interact with the components to see results.
            </p>
          ) : (
                  ...
                  <div>
                    ...
                    {result.shortcut && (
                      <p className="text-xs text-blue-700 mt-2">
                        Shortcut: {result.shortcut.description} (
                        {result.shortcut.key})
                      </p>
                    )}
                  </div>
