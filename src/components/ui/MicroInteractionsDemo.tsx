    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        {reducedMotion && (
          <div className="bg-yellow-100 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/30 text-yellow-800 dark:text-yellow-200 px-4 py-2 rounded-lg mt-4">
            <strong>Reduced Motion Mode:</strong> Some animations are disabled
      ...
      <div className="mt-8 text-center">
        ...
        <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
          All animations are optimized for 60fps performance using CSS
          transforms and opacity changes. They respect the
          prefers-reduced-motion accessibility setting and gracefully degrade
          when disabled.
        </p>
      </div>
    </div>
