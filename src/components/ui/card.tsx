  ...
  (
    ...
    <div
      ...
      className={cn(
        ...
        `card-${variant}`,
        interactive &&
          "card-interactive hover:animate-card-hover cursor-pointer",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-md p-6", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn("leading-snug text-xl font-semibold", className)}
    {...props}
  />
));
